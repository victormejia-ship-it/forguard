...
| `test_resultados_pilares.js` | La vista "Por pilares" de Resultados (Framework de Proforma de Victor): `calcularResultadosPorPilar()` mete cada ingreso/costo en el pilar correcto, suma la nómina por pilar respetando el periodo, y la vista pinta los 4 pilares + Resumen + Gastos de estructura + utilidad operativa |
