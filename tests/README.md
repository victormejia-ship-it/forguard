...
| `test_nomina.js` | Módulo nuevo "Nómina" (fase 1 del rediseño de Resultados): alta/edición/borrado, los 3 indicadores, y que sea invisible e inaccesible (`exigirAdmin()`) para cualquier rol que no sea Owner o Admin |
