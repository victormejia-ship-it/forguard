...
| `test_resultados_proforma.js` | Segundo intento de Resultados (24-sep-2026, rehecho desde cero calcado del Excel "Framework Proforma Forguard V2"): que la app arranque ahí, el gating por rol, que sean EXACTAMENTE 4 secciones (una por pilar) con los renglones y el orden exactos del Excel, que un renglón sin conectar siga en $0; y el primer renglón ya wireado (Pólizas de mantenimiento/…incluidas en precio/Refacciones y materiales): cargo cliente vs. interno, que ambos generen ingreso y costo, que el ingreso cuente por calendario de facturación (no por "cobrado"), el costo repartido parejo entre los 12 meses, y que solo cuenten las pólizas Activas |
